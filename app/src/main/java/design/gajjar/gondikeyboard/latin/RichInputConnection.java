...
import design.gajjar.gondikeyboard.latin.common.UnicodeSurrogate;
import design.gajjar.gondikeyboard.latin.settings.SpacingAndPunctuations;
import design.gajjar.gondikeyboard.latin.utils.CapsModeUtils;
import design.gajjar.gondikeyboard.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See design.gajjar.gondikeyboard.latin.common.Constants.UnicodeSurrogate
